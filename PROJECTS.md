...
| Strideday | `~/workspaces/stride` | strideday.com | Active | Stride CLI / social automation (powers `/social` in this repo). GSC `sc-domain:strideday.com` + GA4 `524125428` wired 2026-08-15 (pass `--sa marketing/google-service-account.json`). Indexing/analytics/404 fixes shipped 2026-08-16; re-audit from that anchor date, see #7. |
