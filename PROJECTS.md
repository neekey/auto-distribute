...
| Strideday | `~/workspaces/stride` | strideday.com | Active | Stride CLI / social automation (powers `/social` in this repo). GSC wired 2026-08-15 (`sc-domain:strideday.com`, pass `--sa marketing/google-service-account.json`); 3/51 URLs indexed — internal linking is the blocker. GA4 property 524125428 wired; blog has zero analytics coverage. |
